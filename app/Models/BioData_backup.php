...
class BioData extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Admin','id','approve_by');
    }

    public function verifyBy()
    {
        return $this->hasMany('App\Models\Admin','id','verify_by');
    }
}
