...
<div id="approvalModal" class="custom-modal">
  <div class="custom-modal-content">
    ...
    <p style="color:black;">
    📜 <strong>মুসলিম বিয়ে-তে বায়োডাটা সাবমিট করার জন্য আন্তরিক মোবারকবাদ!</strong> 🌸
    </p>

    <p style="color:black;">
    🌸 <strong>ইনশাআল্লাহ <u>০৩ কার্যদিবসের মধ্যে</u> ভেরিফিকেশন সম্পন্ন</strong> করে আপনার বায়োডাটা এপ্রুভ করা হবে।
    </p>

    <p style="color:black;">
    🌸 এপ্রুভ হলে <strong>আপনার মেইলে নোটিফিকেশন</strong> যাবে এবং <strong>ড্যাশবোর্ডেও দেখতে পারবেন</strong>।
    </p>

    <p style="color:black;">
    ✨ অনুগ্রহ করে <strong>আপনার মোবাইল নাম্বার</strong>, <strong>অভিভাবকের সম্মতি</strong> ও <strong>নাম্বার সক্রিয়</strong> রাখুন —
    <strong>এটাই হতে পারে আপনার বরকতময় জীবনের প্রথম পদক্ষেপ ইনশাআল্লাহ।</strong> 🕊️
    </p>
