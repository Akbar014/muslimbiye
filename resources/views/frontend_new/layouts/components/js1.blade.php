...
<script src="{{ asset('assets/frontend_new/js/bootstrap.js') }} "></script>
<script src="{{ asset('assets/frontend_new/js/owl.carousel.min.js') }} "></script>
<script src="{{ asset('assets/frontend_new/js/jquery.mCustomScrollbar.concat.min.js') }} "></script>
  ...
  <!--  Custom Activation Script -->
    <script>
      $(document).ready(function () {
        // "Happy Stories"
        $(".last_slider-profiles").owlCarousel({
          items: 4,
          loop: true,
          margin: 25,
          autoplay: true,
        ...
        $(".custom-select-trigger").on("click", function (event) {
          $(".custom-select")
            .not($(this).closest(".custom-select"))
            .removeClass("opened");
          $(this).closest(".custom-select").toggleClass("opened");
          event.stopPropagation();
        });
        $(".custom-option").on("click", function (event) {
          var value = $(this).data("value");
          var text = $(this).text();
          $(this).closest(".custom-select-wrapper").find("select").val(value);
          $(this)
      ...
      (function ($) {
        ...
        // =========================================================
        // নতুন কোড: ভিডিও মডেল দেখানো এবং বন্ধ করার জন্য
        // =========================================================
        function showVideoModal() {
          $("#videoModal").addClass("show");
          // ভিডিওটি প্লে করার চেষ্টা করা হচ্ছে
          $("#videoModal video")
            .get(0)
            .play()
            .catch((error) => {
        ...
        function closeVideoModal() {
          var video = $("#videoModal video").get(0);
          video.pause(); // ভিডিওটি বন্ধ করা হচ্ছে
          video.currentTime = 0; // ভিডিওটি প্রথম থেকে শুরু করার জন্য
          $("#videoModal").removeClass("show");
        }

        // পেজ লোড হওয়ার সাথে সাথেই মডেলটি দেখানোর জন্য
        showVideoModal();

        // ক্লোজ বাটনে ক্লিক করলে মডেল বন্ধ হবে
        $("#closeModalBtn").on("click", closeVideoModal);

        // ব্যাকগ্রাউন্ডে ক্লিক করলে মডেল বন্ধ হবে
        ...
        $(window).scroll(function () {
          if ($(".lccc-section-mains").length) {
            var oTop =
              $(".lccc-section-mains").offset().top - window.innerHeight;
