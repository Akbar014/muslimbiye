...
@section('css')
    ...
    <style>
        ...
        .slider .ageTooltip {
            top: -48px;
            position: absolute;
            box-shadow: 0px 4px 8px rgba(68, 1, 15, 0.25);
        }
        ...
        .range-input input[type="range"]::-webkit-slider-thumb {
            ...
            box-shadow: 0px 2px 8px rgba(68, 1, 15, 0.15);
        }
          ...
          <div class="row" data-${tag}-id="${i}">
              <div class="col-span-12 md:col-span-3">
                  <div class="od-form-group-container required-field">
                      ...
                      <div class="od-form-group-input od-custom-text_box">
                          <input type="text" name="${tag}_names[]" id="${tag}_names" value=""
              ...
              <div class="col-span-12 md:col-span-3">
                  <div class="od-form-group-container required-field">
                      ...
                      <div class="od-form-group-input od-custom-text_box">
                          <input type="text" name="${tag}_educations[]" id="${tag}_educations"
              ...
              <div class="col-span-12 md:col-span-3">
                  <div class="od-form-group-container required-field">
                      ...
                      <div class="od-form-group-input od-custom-text_box">
                          <input type="text" name="${tag}_jobs[]" id="${tag}_jobs" value=""
              ...
              <div class="col-span-12 md:col-span-3">
                  <div class="od-form-group-container required-field">
                      ...
                      <div class="od-form-group-input od-custom-drop_down_select_box">
                          <select class="form-control select2" style="width: 100%" id="${tag}_merital_status"
        ...
        address_containers.forEach(address_container => {
            ...
            document.addEventListener('click', function(event) {
                if (
                    ...
                    addressMenuDropdown.classList.add('d-none');
                }
            });
            ...
            address_container.querySelectorAll('.subdistrict_btn').forEach(subdistrictBtn => {
                ...
                <div class="d-flex align-items-center justify-content-between w-full" style='color:black'>
        ...
        <script>
            ...
            rangeInput.forEach((input) => {
                input.addEventListener("input", function(e) {
                    ...
                    rangeInput[2].value = `${rangeInput[0].value};${rangeInput[1].value}`;
