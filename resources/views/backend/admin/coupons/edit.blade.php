                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="form-group row mb-4 d-block">
                            ...
                            <textarea class="success-story " name="story">{{$data->story}}</textarea>
                          </div>
                          <div class="form-group row mb-4 mx-1">
                            <label class="form-check-label" for="image">Image (Optional)</label>
                            <input class="form-control" type="file" name="image" id="image">
                            @if ($data->image)
                                <img src="{{asset($data->image)}}" alt="image" style="width: 200px; margin-top: 15px;" />
                            @endif
                          </div>
                          <div class="form-group">
                            <label class="d-block">Status</label>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input"  {{ $data->status == '0' ? 'checked' : '' }} type="radio" name="status" id="inlineradio1" value="0">
                              <label class="form-check-label" for="inlineradio1">Pending</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input"  {{ $data->status == '1' ? 'checked' : '' }} type="radio"  name="status" id="inlineradio2" value="1">
