...
@section('title', (isset($data) ? 'Edit' : 'Create') . ' FAQs')
@section('content')
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>{{ isset($data) ? 'Edit' : 'Create' }} New FAQ</div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form id='store'
                action="{{ isset($data) ? route('admin.faqs.update', $data->id) : route('admin.faqs.store') }}"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-4 d-block">
                                    <label for="question_bn">FAQ Question (Bangla)</label>
                                    <input type="text" name="question_bn" id="question_bn" class="form-control"
                                        placeholder="FAQ Question (Bangla)"
                            ...
                            <div class="col-12">
                                <div class="form-group mb-4 d-block">
                                    <label for="question_en">FAQ Question (English)</label>
                                    <input type="text" name="question_en" id="question_en" class="form-control"
                                        placeholder="FAQ Question (English)"
