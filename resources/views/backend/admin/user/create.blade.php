<form id='create' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="needs-validation"
    ...
    <div class="form-row">
        ...
        <div class="col-sm-12 col-md-12 mb-3 mt-3">
            ...
            <div id="vendor_id" class='row mb-3 mt-3'>
                @foreach($roles as $role)
                    @if($role->guard_name = 'admin')
                        <div class="col-md-3 col-sm-12">
                            <input type="checkbox" name="all_role" class="data-check "
...
<script type="text/javascript">
     $(document).ready(function () {
        //alert('dsa');
        var vendorFare = document.getElementById("vendor_id");
        var chks = vendorFare.getElementsByTagName("INPUT");
