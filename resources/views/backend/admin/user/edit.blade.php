    ...
    <div class="form-row">
        ...
        @can('user-password-reset')
            <div class="form-group col-md-6 col-sm-12">
                ...
                <input type="password" class="form-control" id="password" name="password" value="" placeholder="Password (Min:8)">
                <span id="error_password" class="has-error"></span>
            </div>
            <div class="form-group col-md-6 col-sm-12">
                <label for=""> Confirm Password </label>
                <input type="password" class="form-control" id="password" name="password_confirmation" value="" placeholder="Confirm Password">
                ...
                @foreach($roles as $role)
                    @if($role->guard_name = 'admin')
                        <div class="col-sm-12 pt-3">
                            {{Form::radio('roles',  $role->id, $user->roles->contains($role->id), array('class'=>'data-check flat-green')) }}
