    ...
    <ul class="navbar-nav navbar-right">
      ...
      <li class="dropdown"><a href="#" data-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right pullDown">
          ...
          <a href="{{ URL :: to('/admin/profile') }}" class="dropdown-item has-icon"> <i class="far
                                    fa-user"></i> Profile
            <a href="{{ URL :: to('/admin/change_password') }}" class="dropdown-item has-icon"> <i class="fa fa-lock"></i> Change Password
          {{-- </a> <a href="timeline.html" class="dropdown-item has-icon"> <i class="fas fa-bolt"></i>
            Activities --}}
          </a> <a href="{{ URL :: to('/admin/edit_profile') }}" class="dropdown-item has-icon"> <i class="fas fa-cog"></i>
            Edit Profile
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ URL :: to('/admin_login/logout') }}" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
            Logout
          </a>
        </div>
      </li>
