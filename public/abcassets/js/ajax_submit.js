...
function delete_modal(route, id) {
    $("#modal_data").empty();
    $('.modal-title').text('Delete Biodata');
...
function ajax_submit_delete(route, id) {
    swal({
        title: "Are you sure?",
        text: "Deleted data will be moved to trash!!",
        type: "warning",
        showCancelButton: true,
        closeOnConfirm: false,
        showLoaderOnConfirm: true,
...
function ajax_submit_approve(route, id) {
    swal({
        title: "Are you sure?",
        text: "Approve data cannot be recovered!!",
        type: "warning",
        showCancelButton: true,
        closeOnConfirm: false,
        showLoaderOnConfirm: true,
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.type === 'success') {
                    swal("Done!", "Successfully Approve", "success");
                    //reload_table();
                    location.reload();
                } else if (data.type === 'danger') {
                    swal("Error Approve!", "Try again", "error");
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
                swal("Error Approveing!", "Try again", "error");
            }
        });
    });
}

function ajax_submit_reverse(route, id,text,button) {
    swal({
        title: "Are you sure?",
        type: "warning",
        showCancelButton: true,
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.type === 'success') {
                    swal("Done!", "Successfully moved to "+text+"", "success");
                    //reload_table();
                    location.reload();
                } else if (data.type === 'danger') {
                    swal("Error moved to "+text+"!", "Try again", "error");
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
                swal("Error moved to "+text+"!", "Try again", "error");
